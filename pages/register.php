        ...
        <div class="card">
          <div class="row g-0">
            <div class="col-12 col-md-6">
              <img src="assets/images/ica_laguna.png" alt="Image" class="img-fluid rounded-start">
            </div>
            <div class="col-12 col-md-6">
              <div class="card-body">
                ...
                <div class="d-flex gap-1 justify-content-center mt-3">
                  ...
                  <a href="login" class="text-decoration-none text-blue-oscuro fw-semibold">Iniciar sesión</a>
                </div>
              </div>
            </div>
          </div>
