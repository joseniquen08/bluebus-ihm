      ...
      <div class="row text-center">
        <div class="col-md-6 mb-3">
          <div class="fixed-size-container">
            <img src="<?= $base_url ?>/assets/images/huacachina.jpg" class="img-fluid fixed-size" alt="Oasis de Huacachina">
          </div>
          <p class="mt-2">Oasis de Huacachina</p>
        </div>
        <div class="col-md-6 mb-3">
          <div class="fixed-size-container">
            <img src="<?= $base_url ?>/assets/images/paracas.jpg" class="img-fluid fixed-size" alt="Reserva Nacional de Paracas">
          </div>
