      ...
      <div class="row text-center">
        <div class="col-md-6 mb-3">
          <div class="fixed-size-container">
            <img src="<?= $base_url ?>/assets/images/museo_tumbas_reales.jpg" class="img-fluid fixed-size" alt="Museo de las Tumbas Reales de Sipán">
          </div>
          <p class="mt-2">Museo de las Tumbas Reales de Sipán</p>
        </div>
        <div class="col-md-6 mb-3">
          <div class="fixed-size-container">
            <img src="<?= $base_url ?>/assets/images/plaza_principal.jpg" class="img-fluid fixed-size" alt="Plaza de Armas de Chiclayo">
          </div>
