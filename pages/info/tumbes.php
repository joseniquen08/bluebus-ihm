      ...
      <div class="row text-center">
        <div class="col-md-6 mb-3">
          <div class="fixed-size-container">
            <img src="<?= $base_url ?>/assets/images/zorritos.jpg" class="img-fluid fixed-size" alt="Playa Zorritos">
          </div>
          <p class="mt-2">Playa Zorritos</p>
        </div>
        <div class="col-md-6 mb-3">
          <div class="fixed-size-container">
            <img src="<?= $base_url ?>/assets/images/manglares.jpg" class="img-fluid fixed-size" alt="Manglares de Tumbes">
          </div>
