      ...
      <div class="col-12 col-md-10 col-lg-8">
        <div class="card flex-md-row">
          <div class="card-img-left d-none d-md-block">
            <img src="assets/images/pexels-mauricio-espinoza-gavilano-582278929-17029844.jpg" alt="Machu Picchu" class="img-fluid">
          </div>
          <div class="card-body">
            ...
            <div class="d-flex gap-1 justify-content-center mt-3">
              ...
              <a href="registro" class="text-decoration-none text-blue-oscuro fw-semibold">Registrate</a>
            </div>
