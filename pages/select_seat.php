  ...
  <main class="py-4 d-flex flex-column align-items-start mx-auto" style="max-width: 64rem;">
    <div class="w-100 text-center mb-4">
      ...
      <div class="d-flex flex-column justify-content-center align-items-center fs-5">
        ...
        <p><?= date_format(date_create($row["FECHA_VIA"]), "d/m/Y") ?> - <?= date_format(date_create($row["HORA_VIA"]), "g:i A"); ?></p>
      </div>
    </div>
    <div class="d-flex w-100" style="gap: 2rem;">
      <div class="card w-100">
        ...
        <div class="card-body py-4 d-flex flex-column justify-content-center align-items-center" style="gap:2rem">
          <div class="border p-3 rounded-4 text-center" style="border-color: #004080 !important;">
              ...
              while ($i <= $nrAsientos) {
                ...
                ?>
                  <li id="asiento" class="asiento-item">
                    ...
                    <label class="btn btn-outline-primary asiento-btn" style="" for="asiento-<?php echo $i; ?>"><?php echo $i; ?></label><br>
                  </li>
              <?php
                  $i = $i + 1;
                  $j = $j + 1;
      ...
      <div class="d-flex flex-column" style="flex: none; width: 400px; gap: 2rem;">
          ...
          <div class="card-body px-4 py-4">
            ...
            <div id="content">
              <ul class="timeline" style="padding-left: 1rem;">
                ...
                $endTime = date("g:i A", strtotime('+' . ((int)explode("h", $row["DURACION"])[0]) * 60 + (int)explode("min", explode("h ", $row["DURACION"])[1])[0] . ' minutes', $time));
                ?>
        ...
        <form id="datos-compra" action="checkout" method="POST">
          <div class="card">
            <div class="card-header px-4 py-3">
  ...
  <script>
    ...
    function handleClick(precio_const, asiento) {
      if (document.getElementById("asiento-" + asiento).checked) {
        addSeat(precio_const, asiento);
      } else {
        deleteSeat(precio_const, asiento);
      }
    }
