				...
				<div class="col-lg-8">
					<div class="card mb-3">
						...
						<div class="card-body">
							...
							<p><?= htmlspecialchars(date_format(date_create($row["FECHA_VIA"]), "d/m/Y") . ' ' . date_format(date_create($row["HORA_VIA"]), "g:i A")); ?></p>
						</div>
					</div>
						...
						<div class="card-body">
							<ul>
								<?php foreach ($selected_seats as $asiento) : ?>
									<li><?= htmlspecialchars($asiento); ?></li>
								<?php endforeach; ?>
							</ul>
						</div>
					</div>
