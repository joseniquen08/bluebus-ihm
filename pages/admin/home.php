...
<body>
      ...
      <div class="col-md-6">
        <div class="card mb-3">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item"><a href="<?= $base_url ?>/admin/reservas"><i class="bi bi-calendar-check mr-1"></i> Reservas</a></li>
            <li class="list-group-item"><a href="<?= $base_url ?>/admin/usuarios"><i class="bi bi-person mr-1"></i> Usuarios</a></li>
            <li class="list-group-item"><a href="<?= $base_url ?>/admin/viajes"><i class="bi bi-bus-front-fill mr-1"></i> Viajes</a></li>
            <li class="list-group-item"><a href="<?= $base_url ?>/admin/destinos"><i class="bi bi-geo-fill mr-1"></i> Destinos</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card mb-3">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item"><a href="reporte/ventas"><i class="bi bi-file-text"></i> Ventas</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    fetch('<?= $base_url ?>/api/admin/obtener_ventas_mes')
